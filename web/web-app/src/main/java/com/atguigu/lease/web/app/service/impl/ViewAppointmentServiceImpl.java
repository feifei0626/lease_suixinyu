...
public class ViewAppointmentServiceImpl extends ServiceImpl<ViewAppointmentMapper, ViewAppointment>
    ...
    @Autowired
    private ApartmentInfoService apartInfoService;
    ...
    public AppointmentDetailVo getDetailById(Long id) {
        ...
        ApartmentItemVo apartmentItemVo = apartInfoService.selectApartmentItemVoById(viewAppointment.getApartmentId());
